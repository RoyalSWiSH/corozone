 ...
 <Page>
     <ActionBar>            
             <GridLayout rows="*" columns="2*, *, *">
                  <Label text="Contacts (not functional)" column="0"></Label>
     ...
     <StackLayout>
          ...
          <Label v-if="rowCount === 0" :text="'groceries.nogroceryrequests' | L" />
                ...
                <Label text="Active cases in your district: 2 per day in 100000 people / low" row="2" margin="5" fontSize="18" colSpan="3" textWrap="true"/>
                  <Button text="Details" row="3" colSpan="3" @tap="seeDetails(groceryRequests[(i-1)* itemsPerRow])"/> 
     
                <Label text="Your regular contacts (family, houshold members):" row="2" margin="5" fontSize="18" colSpan="3"/>
     <StackLayout>
					<ListView
            class="list-group"
            ...
            height="25%"
          > 
					<Label ref="items" class="input" hint="items" keyboardType="street" autocorrect="false" autocapitalizationType="none" col="0" :text="contact.name"
       ...
       <Label text="Events outside of your regular contacts:" row="2" margin="5" fontSize="18" colSpan="3"/>
     <StackLayout>
					<ListView
            class="list-group"
            for="event in contactOutside"
            style="height:75%"
            separator-color="transparent"
			>
            <v-template>
            ...
            height="25%"
          > 
					<Label ref="items" class="input" hint="items" keyboardType="street" autocorrect="false" autocapitalizationType="none" col="0" :text="event.name"
					 returnKeyType="next" @returnPress="" @tap="" fontSize="18" /> 
           <!-- <Button
              v-if="myUID === gitem.uid"
              col="1"
...
export default {
  data: () => {
    return {
      ...
      contactOutside: [{
          name: "Skiing in Italy, 3 weeks ago"
      },
      {
          name: "Groceries in Rewe, 4 days ago"
      }],
      serverFailure: true,
      groceryRequests: [{
          location: {
